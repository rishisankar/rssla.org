const content = {
    ...
    WELCOME_LETTER: [`
                 ...
                 `,
                 `
                 In these two days, you'll learn what college, UCLA, and RSS are all about — on top of meeting 
